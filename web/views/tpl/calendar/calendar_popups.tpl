                  ...
                  <div class="col-lg-6">
                    <div class="input-group">
                      <div class="input-group-btn">
                        <button id="recurrence_btn" type="button" class="btn btn-default dropdown-toggle text-bold" data-toggle="dropdown" aria-expanded="false">Récurrence <span class="caret"></span></button>
                        <ul class="dropdown-menu" role="menu">
                          <li><a onclick="update_recurrence('jamais')">jamais</a></li>
                          <li><a onclick="update_recurrence('tous les jours')">tous les jours</a></li>
                          <li><a onclick="update_recurrence('tous les semaines')">toutes les semaines</a></li>
                          <li><a onclick="update_recurrence('tous les deux semaines')">toutes les deux semaines</a></li>
                          <li><a onclick="update_recurrence('tous les mois')">toutes les mois</a></li>
                          <li><a onclick="update_recurrence('tous les ans')">toutes les ans</a></li>
                        </ul>
                      </div>
                      <!-- /btn-group -->
                      <div class="form-control" id="recurrence" style="width:200px">jamais</div>
                    </div>
                    <!-- /input-group --> 
                  </div>
                  <!-- /.col-lg-6 --> 
