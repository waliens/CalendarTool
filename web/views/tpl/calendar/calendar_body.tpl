    ...
    <div class="panel-group" id="accordion-upcoming-deadlines" role="tablist" aria-multiselectable="true">
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingOne">
          <h4 class="panel-title"> <img  src="imgs\warning_red.png"/><a data-toggle="collapse" data-parent="#accordion-upcoming-deadlines" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="collapsed"> Deadlines à venir </a> </h4>
        </div>
