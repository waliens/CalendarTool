<?php
	...
	class TestLoadData extends PHPUnit_Framework_TestCase
	{
		...
		{
			$array = array(array("col" => "val1"), array("col" => "val2"));
			$out_array = array(array("col" => "val1", "varying" => array()), 
							   array("col" => "val2", "varying" => array()));
			$column = array("col");
		...
		public function testCommonRegroup_general()
		{
			...
			$out_array = array(array("col1" => "val00", 
									 "varying" => array(array("col2" => "val01", "col3" => "val02"),
														array("col2" => "val21", "col3" => "val22"),
														array("col2" => "val11", "col3" => "val12"))),
							   array("col1" => "val10", 
									 "varying" => array(array("col2" => "val61", "col3" => "val62"),
									 					array("col2" => "val51", "col3" => "val52"),
									 					array("col2" => "val41", "col3" => "val42"),
									 					array("col2" => "val31", "col3" => "val32"))),
							   array("col1" => "val20", 
								     "varying" => array(array("col2" => "val91", "col3" => "val92"),
